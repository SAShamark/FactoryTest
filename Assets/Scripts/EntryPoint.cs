...
public class EntryPoint : MonoBehaviour
{
    ...
    [Inject]
    private void Construct(CurrencyService currencyService, IGameplaySequence gameplaySequence,
    ...
    private void Awake()
    {
        ...
        _gameManager.Initialize(_currencyService, _gameplaySequence, _uiManager, _floatingTextService);
    }
